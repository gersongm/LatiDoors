...
import { dataCustomer } from "./Customer.data"
...
export const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="capitalize w-[300px]">{row.getValue("customer")}</div>,
  },

  {
    ...
    cell: ({ row }) => <div className="capitalize w-[100px]">{row.getValue("invoice")}</div>,
  },
  {
    accessorKey: "amount",
...
export function CustumerDataTable() {
  ...
  return (
    <div className="w-full">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="ml-auto">
              Columnas <ChevronDown className="ml-2 h-4 w-3" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end">
            {table
      ...
      <div className="rounded-md border">
        <Table className="table-row w-full">
          <TableHeader>
